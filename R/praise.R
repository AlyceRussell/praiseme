...
praise <- function (name, punctuation = "!") {
  compliment <- sample(c(glue::glue("You're the best, {name}{punctuation}"),
                         ...
                         glue::glue("I appreciate the effort you put into today {name}. Well done{punctuation}"),
                         glue::glue("There will never be another {name} like you{punctuation}"),
                         glue::glue("{name}, when I think of defining perfection, only you comes to mind{punctuation}"),
